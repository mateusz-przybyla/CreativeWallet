<div class="modal fade" id="edit-<?php echo e($_SESSION['item']); ?>-<?php echo e($category['id']); ?>" tabindex="-1" aria-labelledby="editLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form action="/settings/edit/<?php echo e($_SESSION['item']); ?>/<?php echo e($category['id']); ?>" method="POST">
      <?php include $this->resolve("partials/_csrf.php"); ?>
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="editLabel">Edit category</h1>

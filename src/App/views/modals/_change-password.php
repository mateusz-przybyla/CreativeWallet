<div class="modal fade" id="change-password" tabindex="-1" aria-labelledby="passLabel" aria-hidden="true">
    ...
    <form action="/settings/change/password" method="POST">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="text-danger text-start small" id="oldPasswordModal"></div>
          <div class="mt-2">
            <label for="newPassword" class="col-form-label">Create new password:</label>
            <input type="password" name="newPassword" class="form-control" id="newPassword">
          </div>
          <div class="text-danger text-start small" id="newPasswordModal"></div>
          <div class="mt-2">
          ...
          <div class="text-danger text-start small" id="newPasswordConfirmedModal"></div>
        </div>
